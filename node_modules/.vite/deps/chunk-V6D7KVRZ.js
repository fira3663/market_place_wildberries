...
var _span;
var _excluded = ["aria-describedby", "aria-label", "autoFocus", "autoWidth", "children", "className", "defaultOpen", "defaultValue", "disabled", "displayEmpty", "error", "IconComponent", "inputRef", "labelId", "MenuProps", "multiple", "name", "onBlur", "onChange", "onClose", "onFocus", "onOpen", "open", "readOnly", "renderValue", "SelectDisplayProps", "tabIndex", "type", "value", "variant"];
...
var SelectInput = React.forwardRef(function SelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime2.jsxs)(React.Fragment, {
    children: [(0, import_jsx_runtime.jsx)(SelectSelect, _extends({
    ...
    })), (0, import_jsx_runtime.jsx)(SelectNativeInput, _extends({
      "aria-invalid": error,
      ...
      autoFocus,
      ownerState
    }, other)), (0, import_jsx_runtime.jsx)(SelectIcon, {
      as: IconComponent,
      className: classes.icon,
      ownerState
    }), (0, import_jsx_runtime.jsx)(Menu_default, _extends({
      id: `menu-${name || ""}`,
...
var Select = React3.forwardRef(function Select2(inProps, ref) {
  ...
  return (0, import_jsx_runtime4.jsx)(React3.Fragment, {
    children: React3.cloneElement(InputComponent, _extends({
...
//# sourceMappingURL=chunk-V6D7KVRZ.js.map
